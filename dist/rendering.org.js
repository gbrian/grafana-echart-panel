...
export default function link(scope, elem, attrs, ctrl) {
  var data, panel;
  elem = elem.find('.echart-panel__chart');
  ...
  function addechart() {
    ...
    plotCanvas.bind("plothover", function (event, pos, item) {
      ...
      body = '<div class="echart-tooltip-small"><div class="echart-tooltip-time">';
      body += '<div class="echart-tooltip-value">' + item.series.label + ': ' + formatted;
      body += " (" + percent + "%)" + '</div>';
      body += "</div></div>";
