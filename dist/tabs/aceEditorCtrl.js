...
System.register(['app/core/config'], function (_export, _context) {
  ...
  var config, _createClass, DEFAULT_THEME_DARK, DEFAULT_THEME_LIGHT, AceEditorCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      DEFAULT_THEME_DARK = 'ace/theme/grafana-dark';
      DEFAULT_THEME_LIGHT = 'ace/theme/textmate';

      AceEditorCtrl = function () {
        ...
        _createClass(AceEditorCtrl, [{
          ...
          value: function renderChartOptions() {
            ...
            var onChange = function onChange() {
              tout = null;
              _this.setValue(session.getValue());
          ...
          key: 'setThemeMode',
          value: function setThemeMode(editor) {
        ...
        return AceEditorCtrl;
      }();

      _export('default', AceEditorCtrl);
    }
  };
});
//# sourceMappingURL=aceEditorCtrl.js.map
